...
class Trainer:
    ...
    def _inner_training_loop(
        ...
        for epoch in range(epochs_trained, num_train_epochs):
                ...
                for i, inputs in enumerate(batch_samples):
                    ...
                    if do_sync_step:
                        ...
                        self._maybe_log_save_evaluate(
                            tr_loss, ortho_loss, grad_norm, model, trial, epoch, ignore_keys_for_eval, start_time
                        )
                    else:
            ...
            #修改
            self._maybe_log_save_evaluate(tr_loss, ortho_loss, grad_norm, model, trial, epoch, ignore_keys_for_eval, start_time)
    ...
    def _evaluate(self, trial, ignore_keys_for_eval, skip_scheduler=False):
        ...
        return metrics
    #修改
    def _maybe_log_save_evaluate(self, tr_loss, ortho_loss, grad_norm, model, trial, epoch, ignore_keys_for_eval, start_time):
